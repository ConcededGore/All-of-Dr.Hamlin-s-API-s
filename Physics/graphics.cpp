...
//        sound = std::make_shared<QSoundEffect>(parent);
    ...
    public:
        ...
        Color c;
    public:
        GrobPoint(Point _p, Color _c) : p(_p), c(_c) {}
    ...
    public:
        ...
        Color c;
    public:
        GrobPoints(const std::vector<Point>& points, Color c);
        virtual void draw(QPainter *painter);
    };
    ...
    class GrobPoly : public Grob
    {
        ...
        bool     closed;
    public:
        GrobPoly(const std::vector<Point>& points, Color outlineColor, bool closed, Color fillColor = TRANSPARENT);
        virtual void draw(QPainter *painter);
    };
...
Graphics::Graphics(std::string title, std::function<void (Graphics&)> mainFunc, int width, int height)
...
void Graphics::points(std::vector<Point> pts, Color c)
{
...
GrobPoints::GrobPoints(const std::vector<Point>& points, Color _c)
{
...
GrobPoly::GrobPoly(const std::vector<Point>& points, Color outlineColor, bool closed, Color fillColor)
{
    this->points.resize(points.size());
